...
sNext:"Следующая",sPrevious:"Предыдущая"},sEmptyTable:"No data available in table",sInfo:"Из _TOTAL_ записей показано с _START_ по _END_",sInfoEmpty:"Показано 0 to 0 of 0 записей",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Показать _MENU_ записей",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Поиск:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Нет результатов"},oSearch:f.extend({},q.models.oSearch),sAjaxDataProp:"data",
